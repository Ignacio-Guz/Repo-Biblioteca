...
{
    internal class ClassMetodos
    {

        public static void CargarCombos(ComboBox cmbCategoria, ComboBox cmbEditorial, ComboBox cmbAutor)
        {
        ...
        public static void CargarDatosLibro(
            int codLibro,
            TextBox txtCodLibro,
            TextBox txtTitulo,
            TextBox txtEdicion,
        ...
        public void CargarCombo(ComboBox combo, string sql, string displayMember, string valueMember)
        {
